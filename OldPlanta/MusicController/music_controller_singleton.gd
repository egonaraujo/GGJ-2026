...
var target_volume = -5
@export var time_between_music: float = 0.5
var current_timer = 0
var fade_in = false
...
func _ready():
	...
	phase3_music = preload("res://OldPlanta/MusicController/phase_3.ogg")
	phase4_music = preload("res://OldPlanta/MusicController/phase_4.ogg")
